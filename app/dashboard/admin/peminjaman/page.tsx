    ...
    const handleReject = async () => {
        ...
        try {
            ...
            await logActivity({
                ...
                action: 'update',
                module: 'peminjaman',
                description: `Menolak peminjaman ${selectedLoan.kode_peminjaman || selectedLoan.id}`,
                dataAfter: { status: 'ditolak', peminjaman_id: selectedLoan.id },
            })
    ...
    const handleCancel = async (id: string) => {
        ...
        try {
            ...
            await logActivity({
                ...
                action: 'delete',
                module: 'peminjaman',
                description: `Membatalkan peminjaman ${id}`,
                dataBefore: { peminjaman_id: id },
            })
            fetchData()
        } catch (err: any) {
