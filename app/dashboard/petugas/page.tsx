...
export default function PetugasDashboard() {
    ...
    return (
        <div className="flex flex-1 flex-col gap-6 p-4 pt-0">
            <div className="relative overflow-hidden rounded-[30px] border border-slate-200 bg-[radial-gradient(circle_at_top,_rgba(2,6,23,0.98),_rgba(10,37,64,0.98))] p-6 text-white shadow-[0_20px_60px_rgba(2,6,23,0.25)]">
                ...
                <div className="absolute -right-12 -top-12 h-40 w-40 rounded-full bg-gradient-to-br from-amber-300/40 to-orange-500/30 blur-2xl" />
                <div className="absolute -left-10 bottom-0 h-36 w-36 rounded-full bg-gradient-to-br from-emerald-400/35 to-sky-400/30 blur-2xl" />
                <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="space-y-3">
                        ...
                        <p className="text-sm text-white/70 md:text-base">
                            Selamat datang di panel kontrol SARPRAS. Berikut ringkasan hari ini.
                        </p>
                    </div>
                    ...
                    <Card className="border border-slate-200 bg-white/90 shadow-sm">
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <button
                                ...
                                onClick={() => router.push('/dashboard/petugas/pengembalian')}
                            >
                                <div className="flex items-center gap-3">
